...
class GEGLU(nn.Module):
    def _init_(self, dim_in, dim_out):
        super()._init_()
...
class FeedForward(nn.Module):
    def _init_(self, dim, dim_out=None, mult=4, glu=False, dropout=0.):
        super()._init_()
...
class CrossAttention(nn.Module):
    def _init_(self, query_dim, context_dim=None, heads=8, dim_head=64, dropout=0.):
        super()._init_()
...
class BasicTransformerBlock(nn.Module):
    def _init_(self, dim, n_heads, d_head, dropout=0., context_dim=None, gated_ff=True, checkpoint=True):
        super()._init_()
...
class SpatialTransformer(nn.Module):
    ...
    """
    def _init_(self, in_channels, n_heads, d_head,
...
class Upsample(nn.Module):
    ...
    def _init_(self, channels, use_conv, dims=2, out_channels=None, padding=1):
        super()._init_()
...
class TransposedUpsample(nn.Module):
    ...
    def _init_(self, channels, out_channels=None, ks=5):
        super()._init_()
        self.channels = channels
        self.out_channels = out_channels or channels
...
class Word_Attention(nn.Module):
    def _init_(self, input_size, hidden_size):
        super(Word_Attention, self)._init_()
...
class CharacterEncoder(nn.Module):
    def _init_(self, input_size, hidden_size, max_seq_len):
        super(CharacterEncoder, self)._init_()
